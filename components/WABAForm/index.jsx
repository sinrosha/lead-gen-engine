...
const WABAForm = () => {
  ...
  return (
    <div className="form mt-16 lg:mt-0 p-4 md:p-12 w-full md:w-96 bg-black-bg rounded-md relative">
      <form action="" className={`max-w-md ${formSubmitted ? "invisible" : ""} ${loading ? "invisible" : ""}`}>
        ...
        <button className="px-4 py-1 md:px-6 md:py-2 text-white text-lg font-sen rounded-md bg-pink mt-2 block" onClick={sendLeadToSheet}>Submit</button>
      </form>
